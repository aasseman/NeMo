...
class Select(Operator):
    ...
    def __init__(self, loc=None, color=None, shape=None, when=None, space_type=None):
    ...
    def __call__(self, objset, epoch_now):
        ...
        subset = objset.select(epoch_now, space=space, color=color, shape=shape, when=self.when,)
...
class Switch(Operator):
    ...
    def __init__(self, statement, do_if_true, do_if_false, invalid_as_false=False, both_options_avail=True):
